...
public class ProducerDemoWithKeys {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        for(int i=0; i<10; i++) {
            ...
            ProducerRecord<String, String> record = new ProducerRecord<>("first_topic", "id_" + Integer.toString(i), "hello_world_" + Integer.toString(i));

            logger.info("key id is: " + Integer.toString(i));
